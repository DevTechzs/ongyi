    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="menu-title"><span data-key="t-menu">Ongyi</span></li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#vendor" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="vendor">
                        <i class="ri-account-circle-line"></i></i> <span data-key="vendor">Vendor</span>
                    </a>
                    <div class="collapse menu-dropdown" id="vendor">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="vendor-request" class="nav-link" data-key="t-basic-tables">Requested</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#Delivery" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="Delivery">
                        <i class="ri-account-circle-line"></i></i> <span data-key="Delivery">Delivery</span>
                    </a>
                    <div class="collapse menu-dropdown" id="Delivery">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="delivery-request" class="nav-link" data-key="t-basic-tables">Requested</a>
                            </li>
                            <li class="nav-item">
                                <a href="delivery-approved" class="nav-link" data-key="t-grid-js">Approved</a>
                            </li>
                            <li class="nav-item">
                                <a href="delivery-rejected" class="nav-link" data-key="t-list-js">Rejected</a>
                            </li>
